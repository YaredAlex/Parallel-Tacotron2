...
from model import ParallelTacotron2Loss
...
def main(args, configs):
    ...
    print("len of data is ",len(dataset),f' len of batch is {batch_size} group_size is {group_size}')
    ...
    while True:
        ...
        for batchs in loader:
            for batch in batchs:
                ...
                if step % val_step == 0:
                    model.eval()
                    message = evaluate(model, step, configs, val_logger, vocoder, len(losses), mel_stats)
